...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.spark-bill-datas.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_1') ? 'is-invalid' : '' }}" type="number" name="field_1" id="field_1" value="{{ old('field_1', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_2') ? 'is-invalid' : '' }}" type="number" name="field_2" id="field_2" value="{{ old('field_2', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_3') ? 'is-invalid' : '' }}" type="number" name="field_3" id="field_3" value="{{ old('field_3', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_4') ? 'is-invalid' : '' }}" type="number" name="field_4" id="field_4" value="{{ old('field_4', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_5') ? 'is-invalid' : '' }}" type="number" name="field_5" id="field_5" value="{{ old('field_5', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_6') ? 'is-invalid' : '' }}" type="number" name="field_6" id="field_6" value="{{ old('field_6', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_7') ? 'is-invalid' : '' }}" type="number" name="field_7" id="field_7" value="{{ old('field_7', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_8') ? 'is-invalid' : '' }}" type="number" name="field_8" id="field_8" value="{{ old('field_8', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_9') ? 'is-invalid' : '' }}" type="number" name="field_9" id="field_9" value="{{ old('field_9', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_10') ? 'is-invalid' : '' }}" type="number" name="field_10" id="field_10" value="{{ old('field_10', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_11') ? 'is-invalid' : '' }}" type="number" name="field_11" id="field_11" value="{{ old('field_11', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_12') ? 'is-invalid' : '' }}" type="number" name="field_12" id="field_12" value="{{ old('field_12', '') }}" step="0.01">
