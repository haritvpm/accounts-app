...
@can('head_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.heads.create') }}">
...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.head.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-Head">
                <thead>
                    <tr>
                        <th width="10">
...
@can('head_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.heads.massDestroy') }}",
...
@endcan
  ...
  let table = $('.datatable-Head:not(.ajaxTable)').DataTable({ buttons: dtButtons })
