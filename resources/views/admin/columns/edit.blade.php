...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.columns.update", [$column->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spark_title') ? 'is-invalid' : '' }}" type="text" name="spark_title" id="spark_title" value="{{ old('spark_title', $column->spark_title) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $column->title) }}">
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fieldmapping') ? 'is-invalid' : '' }}" type="text" name="fieldmapping" id="fieldmapping" value="{{ old('fieldmapping', $column->fieldmapping) }}" required>
