...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.spark-bills.update", [$sparkBill->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="date">{{ trans('cruds.sparkBill.fields.date') }}</label>
                <input class="form-control date {{ $errors->has('date') ? 'is-invalid' : '' }}" type="text" name="date" id="date" value="{{ old('date', $sparkBill->date) }}" required>
                @if($errors->has('date'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('acquittance') ? 'is-invalid' : '' }}" type="text" name="acquittance" id="acquittance" value="{{ old('acquittance', $sparkBill->acquittance) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sparkcode') ? 'is-invalid' : '' }}" type="text" name="sparkcode" id="sparkcode" value="{{ old('sparkcode', $sparkBill->sparkcode) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bill_type') ? 'is-invalid' : '' }}" type="text" name="bill_type" id="bill_type" value="{{ old('bill_type', $sparkBill->bill_type) }}">
