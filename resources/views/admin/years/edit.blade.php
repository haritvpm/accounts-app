    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.years.update", [$year->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('financial_year') ? 'is-invalid' : '' }}" type="text" name="financial_year" id="financial_year" value="{{ old('financial_year', $year->financial_year) }}" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('active') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="active" id="active" value="1" {{ $year->active || old('active', 0) === 1 ? 'checked' : '' }}>
