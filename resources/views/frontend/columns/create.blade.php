    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.columns.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="spark_title" id="spark_title" value="{{ old('spark_title', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="fieldmapping" id="fieldmapping" value="{{ old('fieldmapping', '') }}" required>
