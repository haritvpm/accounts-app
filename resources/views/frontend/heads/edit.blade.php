    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.heads.update", [$head->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="object_head">{{ trans('cruds.head.fields.object_head') }}</label>
                            <input class="form-control" type="text" name="object_head" id="object_head" value="{{ old('object_head', $head->object_head) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="object_head_name" id="object_head_name" value="{{ old('object_head_name', $head->object_head_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="detail_head" id="detail_head" value="{{ old('detail_head', $head->detail_head) }}" required>
