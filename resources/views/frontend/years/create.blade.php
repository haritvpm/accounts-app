    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.years.store") }}" enctype="multipart/form-data">
                        {{ method_field('POST') }}
                        {{ csrf_field() }}
                        <div class="form-group">
                            <label class="required" for="financial_year">{{ trans('cruds.year.fields.financial_year') }}</label>
                            <input class="form-control" type="text" name="financial_year" id="financial_year" value="{{ old('financial_year', '') }}" required>
