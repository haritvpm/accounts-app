    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.spark-bill-datas.update", [$sparkBillData->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="net">{{ trans('cruds.sparkBillData.fields.net') }}</label>
                            <input class="form-control" type="number" name="net" id="net" value="{{ old('net', $sparkBillData->net) }}" step="0.01">
                            @if($errors->has('net'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="field_1" id="field_1" value="{{ old('field_1', $sparkBillData->field_1) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="field_2" id="field_2" value="{{ old('field_2', $sparkBillData->field_2) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="field_3" id="field_3" value="{{ old('field_3', $sparkBillData->field_3) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="field_4" id="field_4" value="{{ old('field_4', $sparkBillData->field_4) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="field_5" id="field_5" value="{{ old('field_5', $sparkBillData->field_5) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="field_6" id="field_6" value="{{ old('field_6', $sparkBillData->field_6) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="field_7" id="field_7" value="{{ old('field_7', $sparkBillData->field_7) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="field_8" id="field_8" value="{{ old('field_8', $sparkBillData->field_8) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="field_9" id="field_9" value="{{ old('field_9', $sparkBillData->field_9) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="field_10" id="field_10" value="{{ old('field_10', $sparkBillData->field_10) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="field_11" id="field_11" value="{{ old('field_11', $sparkBillData->field_11) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="field_12" id="field_12" value="{{ old('field_12', $sparkBillData->field_12) }}" step="0.01">
