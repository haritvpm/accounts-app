        ...
        <div class="col-md-12">
            ...
            <!-- <div class="card"> -->
                <div class="card-header">
                    {{ trans('global.create') }} {{ trans('cruds.salaryBillDetail.title_singular') }} <b><div id="pwn"></div></b>
                </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.salary-bill-details.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control total_bill" type="number" name="pay" id="pay" value="{{ old('pay', '0') }}" step="0.01" required>
                            @if($errors->has('pay'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control total_bill" type="number" name="da" id="da" value="{{ old('da', '0') }}" step="0.01" required>
                            @if($errors->has('da'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('da') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control total_bill" type="number" name="hra" id="hra" value="{{ old('hra', '0') }}" step="0.01" required>
                            @if($errors->has('hra'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('hra') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control total_bill" type="text" name="other" id="other" value="{{ old('other', '0') }}" step="1" required>
                            @if($errors->has('other'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('other') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control total_bill" type="number" name="ota" id="ota" value="{{ old('ota', '0') }}" step="0.01">
                            @if($errors->has('ota'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ota') }}
                                </div>
